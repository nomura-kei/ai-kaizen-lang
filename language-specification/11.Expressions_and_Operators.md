...
Expressions shall contain at most one operator.

Complex expressions shall be decomposed into intermediate variables.
...
Because expressions contain at most one operator, parentheses are not required to control operator precedence.
