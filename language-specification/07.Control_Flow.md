...
MATCH selects one function invocation based on a value.

Each branch consists of exactly one function call.
...
Each branch shall occupy one line.

Executable blocks are not supported.
